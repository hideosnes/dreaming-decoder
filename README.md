# Dreaming Decoder
Self-host your Podcast (WIP). Made with Svelte5, Tailwind and using Pocketbase as a backend, so you can self-host podcasts.
This project is currently under activ development. Until the project reached a certain grade of maturity (~V0.0.8) it is (!)*NOT*(!) recommended to use in production.
...
* Order this list and add version #'s
* Sort episodes by types
* display all categories
* display categories on episode tile
* audioContext for timeline
